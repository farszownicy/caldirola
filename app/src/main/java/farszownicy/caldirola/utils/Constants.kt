...
object Constants {
    ...
    const val EDIT_TASK_CODE = 8
    const val EDIT_EVENT_KEY = "EDIT_EVENT"
    const val SHARED_PREF_CALENDAR_FILE_NAME = "CALENDAR"
    ...
    const val SHARED_PREF_INTERVALS_LIST_KEY = "INTERVALS"
    const val SHARED_PREF_MAX_TASKS_KEY = "MAX_TASKS"
    const val SHARED_PREF_MINUTES_BETWEEN_KEY = "MIN_TIME_BETWEEN"
    const val DATE_FORMAT = "dd.MM.yyyy"
    const val TIME_FORMAT = "HH:mm"
    const val DATETIME_FORMAT = "dd.MM.yyyy HH:mm"
    const val SHORT_DATETIME_FORMAT = "dd.MM.yy HH:mm"
    const val DAY_OF_MONTH_FORMAT = "dd MMM"
