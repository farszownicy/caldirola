package farszownicy.caldirola.agendacalendar.calendar.weekslist;
        ...
        public void bindWeek(WeekItem weekItem, Calendar today) {
            ...
            for (int c = 0; c < dayItems.size(); c++) {
                ...
                if (dayItem.getValue() == 15) {
                    ...
                    SimpleDateFormat monthDateFormat = new SimpleDateFormat(mContext.getResources().getString(R.string.month_name_format),
